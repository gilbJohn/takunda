...
export const MOCK_DECKS: Deck[] = [
  ...
  },
  {
    ...
    cards: [
      { id: "j1", front: "What is an algorithm?", back: "A step-by-step procedure for solving a problem." },
      { id: "j2", front: "What is a variable?", back: "A named storage location that holds a value." },
      { id: "j3", front: "What is a loop?", back: "A control structure that repeats instructions." },
      { id: "j4", front: "What is OOP?", back: "Object-Oriented Programming." },
      { id: "j5", front: "What is API?", back: "Application Programming Interface." },
      { id: "j6", front: "What is a function?", back: "A reusable block of code that performs a task." },
      ...
      { id: "j10", front: "What is a hash table?", back: "A data structure for key-value lookups." },
      { id: "j11", front: "What is Big O notation?", back: "Measures algorithmic complexity." },
      { id: "j12", front: "What is Git?", back: "A version control system." },
      { id: "j13", front: "What is SQL?", back: "Structured Query Language for databases." },
      { id: "j14", front: "What is REST?", back: "Representational State Transfer API design." },
      { id: "j15", front: "What is MVC?", back: "Model-View-Controller architecture." },
      { id: "j16", front: "What is a compiler?", back: "Translates source code to machine code." },
      { id: "j17", front: "What is an array?", back: "A contiguous collection of elements." },
      { id: "j18", front: "What is a linked list?", back: "Elements linked by pointers." },
      { id: "j19", front: "What is a binary tree?", back: "A tree with at most two children per node." },
      { id: "j20", front: "What is async/await?", back: "JavaScript pattern for asynchronous code." },
      { id: "j21", front: "What is a closure?", back: "A function that captures its lexical scope." },
      { id: "j22", front: "What is the DOM?", back: "Document Object Model for web pages." },
      { id: "j23", front: "What is React?", back: "A JavaScript library for building UIs." },
